-- ============================================================
-- VIIT CR ELECTIONS 2026 - PRODUCTION POSTGRESQL SCHEMA
...
-- 3. Students Table (Official 250 Voter Roster for Data Science)
...
-- 5. Votes Table (Cryptographically sealed immutable ledger)
CREATE TABLE IF NOT EXISTS votes (
    ...
    -- MANDATORY HIGHEST PRIORITY DATABASE CONSTRAINT: ONE STUDENT ONE VOTE
...
-- 6. Dedicated Idempotency Table: vote_requests
...
-- 8. Audit Logs Table (Tamper-evident append-only journal)
